...
@implementation SHUTreeViewCell
...
- (void) setExpanded:(BOOL)flag{
	if (_expanded != flag) {
		...
		CATransform3D transform = _expanded?CATransform3DRotate(self.dirAccessoryLayer.transform, M_PI/2, 0, 0, 1.0):CATransform3DIdentity;
